	...
	public static void main(String[] args) {
		...
		try {
	        ...
	        while(quit == false)
	        {
	        	...
	        	else if(message.equals("-gc")) //group chat?
	        	{
	        	...
	        	else if(message.equals("-m")) //single msg
	        	{
	        	...
	        	else if(message.equals("-gm")) //group msg
	        	{
	        		System.out.println("What message would you like to send?");
	        		message = scanIn.nextLine();
	        		System.out.println("Who to send to?");
	        	...
	        	else if(message.equals("-b")) //broadcast
	        	{
	        		//message = scanIn.nextLine();
	        		client.send(message);
		        	System.out.println(client.getName() + "Message Sent!");		        	
